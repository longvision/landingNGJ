...
const SubContainer1 = styled_components__WEBPACK_IMPORTED_MODULE_11___default.a.div.withConfig({
  displayName: "pages__SubContainer1",
  componentId: "mytn3e-1"
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;"]);
const SubContainer2 = styled_components__WEBPACK_IMPORTED_MODULE_11___default.a.div.withConfig({
...
})(["font-size:21px;margin:15px;text-align:center;margin-top:-10px;color:", ";"], ({
  theme
}) => theme.colors.text);
