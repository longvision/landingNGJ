...
})(["display:flex;position:absolute;flex-direction:row;align-items:center;justify-content:center;flex-wrap:wrap;"]);
...
})(["margin-top:10px;font-size:38px;text-align:justify;color:", ";"], function (_ref) {
...
})(["margin-top:0px;font-size:44px;text-align:justify;font-weight:bold;color:", ";"], function (_ref2) {
...
})(["margin:30px 30px;width:30%;height:30%;max-height:250px;max-width:250px;border-radius:12px;flex-direction:column;align-items:stretch;justify-content:center;display:flex;"]);
...
//# sourceMappingURL=index.js.26a1747506c97e8320d2.hot-update.js.map